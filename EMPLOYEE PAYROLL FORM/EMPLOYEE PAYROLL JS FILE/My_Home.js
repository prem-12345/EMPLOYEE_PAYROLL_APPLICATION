...
const createInnnerHtml = () => {
    ...
    for (const employeePayrollData of empPayrollList){
        ...
        <td>
            <img id="${employeePayrollData._id}" onclick="remove(this)" alt="delete" src="../icons/delete-black-18dp.svg" >
            <img id="${employeePayrollData._id}" onclick="update(this)" alt="Edit" src="../icons/create-black-18dp.svg">
        </td>
    </tr>
    `;
    }
